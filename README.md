# Croissant-Coursier
![](https://github.com/qelindent/Croissant-Coursier/blob/main/logo.png)
...
- Admin user can be created manually in the database with username 'admin'.
- Admin can add new products from the interface after login.
